...
namespace YonderSharp
{
    ...
    public class Permutations
    {
        public string[] GetAllPermutation<T>(T[] items)
        {
            ...
            ForAllPermutation(items, (vals) =>
            {
                result.Add(string.Join("", vals.Select(x => x.ToString())));
                return false;
            });
        ...
        public bool ForAllPermutation<T>(T[] items, Func<T[], bool> funcExecuteAndTellIfShouldStop)
        {
